// filepath: /c:/Users/Shoot/Desktop/1.Computer Science/Portfolio 2025/portfolio/app/components/ProfileCard.jsx
'use client';
...
export default function ProfileCard() {
  ...
  return (
    <div className="p-8 flex justify-center items-center mt-16 md:mt-16">
      <Card className={`relative w-[250px] h-[405px] rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 border ${theme === 'dark' ? 'bg-emerald-900 border-emerald-800' : 'bg-emerald-900 border-emerald-800'}`}>
